...
export default function SellerMatchPage({ params }: Props) {
  ...
  useEffect(() => {
    if (window.innerWidth > 768) {
      router.replace(`/seller/events/${eventId}/discover`);
    }
  }, [eventId, router]);
    ...
    >
      ...
      <div className="flex-1 relative flex items-center justify-center px-5 z-10">
        ...
        {!hasCards ? (
          <div className="flex flex-col items-center gap-4 text-center px-8">
            ...
            <p className="text-[13px]" style={{ color: "rgba(255,255,255,.45)" }}>Check back when new buyers are added to this event.</p>
          </div>
        ) : (
          <>
            {/* Back card */}
      ...
      >
        ...
        <div className="flex flex-col gap-2.5 w-[85%] relative z-10">
          <button
            onClick={() => { closeCelebration(); router.push(`/seller/events/${eventId}/matches`); }}
